...
export class GameListComponent implements OnInit, OnDestroy {
 ...
 showMobileorWebViewDialog(data, provierId) {
  ...
  {    
    ...
    this.router.navigate(['/game/wallet'], {state: {providerType: this.providerId,gameName: this.gameName,gameType: "in"},replaceUrl: false})
  }

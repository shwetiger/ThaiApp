...
export class GamecategoryComponent implements OnInit, OnDestroy {
  ...
  playAutoGameListLaunch()
  {
    var launchGameModel= this.storage.retrieve("localLiveGameLaunch").list;
    var providerId= this.storage.retrieve("localLiveGameLaunch").providerId;
    var providerName=this.storage.retrieve("localLiveGameLaunch").providerName;
    ...
    .subscribe(
      result => {        
        ...
        this.storage.clear("localLiveGameLaunch");
        ...
        {                     
          ...
          if(launchGameModel.option == true){           
            this.spinner.hide("smallSpinner");
            var data={
              'gameId': launchGameModel.providercode+"_"+launchGameModel.code,
              'providerCode': providerName,
              'lang': this.gameLanguage(),
              'type': launchGameModel.type
            }
             ...
             if(this.launchGameResModel.parameters == "openinnewtap"){     
              var gamelist=this.storage.retrieve('localLaunchGameList');
               ...
               this.router.navigate(['/game-play'],{state: {launchUrl: this.launchGameResModel.gameUrl,launchTag: "openinnewtap",launchTagName: this.launchTagName,
                providerId: providerId},replaceUrl: false});             
             }    
            }
          );
              }

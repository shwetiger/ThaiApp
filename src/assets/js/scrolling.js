...
let currentYear = 1//new Date().getFullYear();
let currentMonth = 1;
let currentDay = 1;
...
yearSelector = new IosSelector({
    ...
    document.querySelector('#number-swiper-value').value=yearSelector.value+""+monthSelector.value+""+daySelector.value;
...
// let currentYear = 0//new Date().getFullYear();
// let currentMonth = 0;
// let currentDay = 0;
